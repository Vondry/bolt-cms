...
- We have also updated our Doctrine versions (data-fixtures ^2.0, dbal ^4.0, doctrine-fixtures-bundle ^4.3, lexer ^3, orm ^3.5). You will need to check your own entities and implementation to make sure that your code is compatible with the doctrine related changes.
...
- If you were using `bobdenotter/sitemap`, you can migrate to `bolt/sitemap-extension`.  The namespace has changed from `Bobdenotter\Sitemap` to `Bolt\SitemapExtension`.
...
- `php-translation/symfony-bundle` has been bumped to `^0.16`.
